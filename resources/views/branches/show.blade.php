        ...
        <div class="mx-auto max-w-7xl">
            ...
            <div class="mb-8">
                <a href="{{ route('branch.index') }}"
                    ...
                    <svg class="mr-2.5 h-4 w-4 transform transition-transform group-hover:-translate-x-0.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
            ...
            <div class="relative mb-10 overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-10 shadow-2xl">
                ...
                <div class="relative flex flex-col justify-between lg:flex-row lg:items-start">
                    <div class="mb-8 lg:mb-0">
                        ...
                        <h1 class="mb-4 text-5xl font-bold text-white tracking-tight">{{ $branch->name }}</h1>

                        <div class="mb-6 flex items-center text-slate-300">
                            <svg class="mr-3 h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                    ...
                    <div class="flex gap-3">
                        <a href="{{ route('branch.edit', $branch->id) }}"
                            ...
                            <svg class="mr-2.5 h-5 w-5 transition-transform group-hover:rotate-12" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div class="mb-10 grid grid-cols-1 gap-6 md:grid-cols-3">
                <div class="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]">
                    <div class="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-gradient-to-br from-blue-500/10 to-transparent"></div>
                    <div class="relative flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600">Total Invoices</p>
                            <p class="mt-2 text-4xl font-bold text-gray-900 tracking-tight">{{ $branch->invoices->count() }}</p>
                            <div class="mt-2 flex items-center">
                                ...
                                <span class="text-sm text-green-600">{{ $branch->invoices->where('status', 'paid')->count() }} paid</span>
                            </div>
                        </div>
                ...
                <div class="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]">
                    <div class="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-gradient-to-br from-emerald-500/10 to-transparent"></div>
                    <div class="relative flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600">Accountants</p>
                            <p class="mt-2 text-4xl font-bold text-gray-900 tracking-tight">{{ $branch->accountants->count() }}</p>
                ...
                <div class="group relative overflow-hidden rounded-2xl bg-white p-6 shadow-lg transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]">
                    <div class="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-gradient-to-br from-purple-500/10 to-transparent"></div>
                    <div class="relative flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-600">Branch Created</p>
                            <p class="mt-2 text-3xl font-bold text-gray-900 tracking-tight">{{ $branch->created_at->format('M d, Y') }}</p>
...
<div class="lg:col-span-2">
    <div class="overflow-hidden rounded-2xl bg-white shadow-2xl">
        <div class="border-b border-gray-100 bg-gradient-to-r from-white to-gray-50 px-8 py-6">
            <div class="flex flex-col justify-between sm:flex-row sm:items-center">
                ...
                <a href="{{ route('invoice.create', ['branch_id' => $branch->id]) }}"
                    ...
                    <svg class="mr-3 h-5 w-5 transition-transform group-hover:rotate-90" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        @foreach ($branch->invoices as $invoice)
                            <tr class="group transition-all duration-300 hover:bg-gray-50/80">
                                ...
                                <td class="px-8 py-5">
                                    <div class="font-medium text-gray-900">{{ $invoice->customer->name ?? 'N/A' }}</div>
                                ...
                                <td class="px-8 py-5">
                                    @if ($invoice->creator)
                                        <div class="flex items-center">
                                            <div class="mr-3 flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-emerald-100 to-emerald-50 shadow-sm">
                                            ...
                                            <div>
                                                <div class="font-medium text-gray-900">{{ $invoice->creator->name }}</div>
                                                <div class="text-xs text-gray-500">Accountant</div>
                                            </div>
                                        </div>
                                    @elseif ($invoice->user)
                                        <div class="flex items-center">
                                            <div class="mr-3 flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-100 to-blue-50 shadow-sm">
                                ...
                                <td class="px-8 py-5">
                                    ...
                                    @if ($invoice->paid > 0)
                                        <div class="text-xs text-green-600">
                                            Paid: {{ $invoice->currency }} {{ number_format($invoice->paid, 2) }}
                                        </div>
                                    @endif
                                </td>
                                <td class="px-8 py-5">
                                    @if ($invoice->status === 'paid')
                                        <span class="inline-flex items-center rounded-full bg-gradient-to-r from-emerald-50 to-emerald-100 px-3 py-1.5 text-xs font-semibold text-emerald-800">
                                            <span class="mr-1.5 h-2 w-2 rounded-full bg-emerald-500"></span>
                                            Paid
                                        </span>
                                    @elseif($invoice->status === 'pending')
                                        @if ($invoice->due_date && $invoice->due_date->isPast())
                                            <span class="inline-flex items-center rounded-full bg-gradient-to-r from-rose-50 to-rose-100 px-3 py-1.5 text-xs font-semibold text-rose-800">
                                                <span class="mr-1.5 h-2 w-2 rounded-full bg-rose-500"></span>
                                                Overdue
                                            </span>
                                        @else
                                            <span class="inline-flex items-center rounded-full bg-gradient-to-r from-amber-50 to-amber-100 px-3 py-1.5 text-xs font-semibold text-amber-800">
                                                <span class="mr-1.5 h-2 w-2 rounded-full bg-amber-500"></span>
                                                Pending
                                            </span>
                                        @endif
                                    @else
                                        <span class="inline-flex items-center rounded-full bg-gradient-to-r from-gray-50 to-gray-100 px-3 py-1.5 text-xs font-semibold text-gray-800">
                                ...
                                <td class="px-8 py-5">
                                    @if ($invoice->due_date)
                                        <div class="text-sm font-medium text-gray-900">{{ $invoice->due_date->format('M d, Y') }}</div>
                ...
                <div class="flex flex-col justify-between sm:flex-row sm:items-center">
                    ...
                    <div class="flex items-center space-x-6">
                        ...
                        <div class="text-sm font-semibold text-gray-900">
                            Total: {{ $branch->invoices->first()->currency ?? 'USD' }} {{ number_format($branch->invoices->sum('total_amount'), 2) }}
                        </div>
                    </div>
                </div>
            </div>
        @else
            <div class="py-20 text-center">
                <div class="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-gradient-to-br from-gray-100 to-gray-50 shadow-lg">
                    <svg class="h-12 w-12 text-gray-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
                </div>
        ...
        @endif
                ...
                <div class="lg:col-span-1">
                    <div class="sticky top-8 overflow-hidden rounded-2xl bg-white shadow-2xl">
                        <div class="border-b border-gray-100 bg-gradient-to-r from-white to-gray-50 px-8 py-6">
                            <div class="flex flex-col justify-between sm:flex-row sm:items-center">
                                <div>
                                    <h2 class="text-2xl font-bold text-gray-900 tracking-tight">Accountants</h2>
                                    <p class="mt-1 text-sm text-gray-600">Team managing this branch</p>
                                </div>
                                <button onclick="openModal('create-accountant-modal')"
                                    class="group mt-4 inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-700 px-5 py-3 font-semibold text-white shadow-lg transition-all duration-300 hover:from-emerald-700 hover:to-emerald-800 hover:shadow-xl sm:mt-0">
                                    <svg class="mr-3 h-5 w-5 transition-transform group-hover:rotate-180" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
                                    </svg>
                                    Add Accountant
                                </button>
                        ...
                        <div class="p-8">
                            @if ($branch->accountants->count())
                                <div class="space-y-6">
                                    @foreach ($branch->accountants as $accountant)
                                        <div class="group relative overflow-hidden rounded-xl border border-gray-200 bg-white p-6 transition-all duration-300 hover:border-emerald-300 hover:shadow-lg">
                                            <div class="absolute inset-0 bg-gradient-to-r from-emerald-50/0 to-emerald-50/0 transition-all duration-500 group-hover:from-emerald-50/50 group-hover:to-emerald-50/30"></div>
                                            <div class="relative">
                                                <div class="flex items-start justify-between">
                                                    <div class="flex items-center">
                                                        <div class="mr-4 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 shadow-md">
                                                            <span class="text-lg font-semibold text-white">
                                                                {{ substr($accountant->name, 0, 1) }}
                                                            </span>
                                                        </div>
                                                        <div>
                                                            <h3 class="font-bold text-gray-900">{{ $accountant->name }}</h3>
                                            ...
                                            <!-- Delete Button -->
                                            <form action="{{ route('branch.accountant.destroy', [$branch->id, $accountant->id]) }}" method="POST" class="absolute right-4 top-4">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('Remove {{ $accountant->name }} from this branch?');"
                                                    class="group/delete flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-white to-gray-50 text-gray-400 shadow-sm ring-1 ring-gray-200 transition-all duration-300 hover:scale-110 hover:bg-gradient-to-br hover:from-rose-50 hover:to-rose-100 hover:text-rose-600 hover:shadow-md hover:ring-rose-200">
                                                    <svg class="h-4 w-4 transition-transform group-hover/delete:rotate-90" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
                            ...
                            @else
                                <div class="py-12 text-center">
                                    <div class="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-gray-100 to-gray-50 shadow-lg">
                                        <svg class="h-10 w-10 text-gray-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                                        </svg>
                                    </div>
                                    <h3 class="mb-2 text-lg font-semibold text-gray-900">No accountants assigned</h3>
                                    <p class="mb-6 text-gray-500">Add accountants to manage branch invoices</p>
                                    <button onclick="openModal('create-accountant-modal')"
                                        class="inline-flex items-center rounded-xl bg-gradient-to-r from-emerald-600 to-emerald-700 px-6 py-3 font-semibold text-white shadow-lg transition-all duration-300 hover:from-emerald-700 hover:to-emerald-800 hover:shadow-xl">
    ...
    <div id="create-accountant-modal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/70 backdrop-blur-sm"
        onclick="if(event.target === this) closeModal('create-accountant-modal')">
        <div class="relative w-full max-w-lg transform transition-all duration-300 scale-95 opacity-0" id="modal-content">
