        ...
        <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div class="animate-fade-in mb-12">
                <div class="flex items-center justify-between">
                    <div>
                        <h1
                            class="bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-900 bg-clip-text text-4xl font-bold text-transparent">
                            Account Settings
                        </h1>
            ...
            @if (session('success'))
                <div class="animate-slide-down mb-8">
                    <div
                        class="relative overflow-hidden rounded-2xl border border-emerald-200 bg-gradient-to-r from-emerald-50 to-teal-50 p-5 shadow-lg backdrop-blur-sm">
                        <div class="absolute inset-0 bg-gradient-to-r from-emerald-400/10 to-teal-400/10"></div>
                        <div class="relative flex items-center">
                            <div
                                class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-emerald-500 shadow-lg">
            ...
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-12">
                ...
                <div class="lg:col-span-4 xl:col-span-3">
                    <div class="sticky top-8 space-y-6">
                        ...
                        <!-- Profile Card -->
                        <div
                            class="group relative overflow-hidden rounded-3xl bg-white p-8 shadow-xl transition-all duration-300 hover:shadow-2xl">
                            <!-- Gradient Background -->
                            <div
                                class="absolute inset-0 bg-gradient-to-br from-blue-500/5 via-indigo-500/5 to-purple-500/5">
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <div class="mb-6 flex justify-center">
                                    <div class="relative">
                                        <!-- Main Avatar -->
                                        <div
                                            class="relative h-32 w-32 overflow-hidden rounded-3xl bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-600 p-1 shadow-2xl transition-all duration-300 group-hover:rotate-3 group-hover:scale-105">
                                            <div
                                                class="flex h-full w-full items-center justify-center overflow-hidden rounded-3xl bg-white">
                                                @if (auth()->user()->logo_path)
                                                    <img src="{{ asset('storage/' . auth()->user()->logo_path) . '?v=' . time() }}"
                                                        class="h-full w-full object-cover">
                                                @else
                                                    <span
                                                        class="bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-600 bg-clip-text text-4xl font-bold text-transparent"
                                                        id="logoInitials">
                        ...
                        <nav class="space-y-2 rounded-3xl bg-white p-4 shadow-xl">
                            <a href="#profile" onclick="showSection('profile')"
                                class="nav-link active group flex items-center rounded-2xl px-4 py-3.5 font-medium text-slate-700 transition-all duration-300">
                                <div
                                    class="mr-3 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-lg transition-transform duration-300 group-hover:scale-110">
                        ...
                        <div class="rounded-3xl bg-gradient-to-br from-blue-500 to-indigo-600 p-6 text-white shadow-xl">
                            ...
                            <button
                                class="w-full rounded-xl bg-white py-2.5 font-medium text-blue-600 transition-all hover:shadow-lg">
                ...
                <div class="lg:col-span-8 xl:col-span-9">
                    <div class="space-y-6">
                        ...
                        <div id="profile-section"
                            class="section-content overflow-hidden rounded-3xl bg-white shadow-xl transition-all duration-300">
                            <!-- Header -->
                            <div class="border-b border-slate-100 bg-gradient-to-r from-slate-50 to-blue-50 px-8 py-6">
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-slate-600">Update your personal details and information
                                        </p>
                                    </div>
                                    <div
                            ...
                            <div class="p-8">
                                <form method="POST" action="{{ route('profile.update') }}">
                                    ...
                                    <div
                                        class="mt-8 flex items-center justify-between rounded-2xl bg-gradient-to-r from-slate-50 to-blue-50 p-6">
                                        <div class="flex items-center text-sm text-slate-600">
                                            <i class="fas fa-info-circle mr-2 text-blue-500"></i>
                                            <span>All changes are saved securely</span>
                                        </div>
                                        <button type="submit"
                                            class="group relative overflow-hidden rounded-xl bg-gradient-to-r from-blue-500 to-indigo-600 px-8 py-3.5 font-semibold text-white shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl">
                                            <span class="relative z-10 flex items-center">
                                                <i class="fas fa-save mr-2"></i>Save Changes
                                            </span>
                                            <div
                                                class="absolute inset-0 -z-0 bg-gradient-to-r from-indigo-600 to-purple-600 opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                                            </div>
                                        </button>
                                    </div>
                                </form>
    ...
    <script>
        ...
        function showSection(section) {
            ...
            document.querySelectorAll('.nav-link').forEach(link => {
                ...
                if (icon) {
                    icon.classList.remove('bg-gradient-to-br', 'from-blue-500', 'to-indigo-600', 'text-white',
                        'shadow-lg');
