        ...
        <div class="">
            ...
            @if (session('success'))
                <div class="alert alert-success alert-dismissible fade show d-flex align-items-center mb-4" role="alert"
                    ...
                    <i class="isax isax-tick-circle fs-5 me-2"></i>
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="text-muted fs-14 mb-0">Manage your inventory and product catalog</p>
                </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="position-relative">
                                <input type="text" class="form-control ps-5" placeholder="Search products..." x-data
                                    x-ref="searchInput">
                                <i
                                    class="isax isax-search-normal position-absolute top-50 translate-middle-y text-muted ms-3"></i>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-6" x-data="{ open: false, selected: 'Latest' }" @click.away="open = false">
                            ...
                            <ul class="dropdown-menu w-100 shadow-sm" :class="{ 'show': open }" x-show="open" x-transition>
                                <li>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table-hover table-nowrap mb-0 table">
                            ...
                            <tbody>
                                @forelse ($products as $product)
                                    <tr class="align-middle">
                                        ...
                                        <td>
                                            <span class="badge bg-light text-primary border-primary fw-medium border">
                                                {{ $product->code }}
                                            </span>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar avatar-sm bg-light me-3 rounded p-2">
                                        ...
                                        <td>
                                            <span
                                                class="badge bg-{{ $product->type === 'product' ? 'primary' : 'info' }}-subtle text-{{ $product->type === 'product' ? 'primary' : 'info' }} px-3 py-2">
                                        ...
                                        <td>
                                            <span
                                                class="badge {{ $product->quantity > 50 ? 'bg-success-subtle text-success' : ($product->quantity > 10 ? 'bg-warning-subtle text-warning' : 'bg-danger-subtle text-danger') }} px-3 py-2">
                                                {{ $product->quantity }} {{ $product->unit }}
                                            </span>
                                        </td>
                                        <td>
                                            <span
                                                class="fw-medium text-dark">₦{{ number_format($product->selling_price, 2) }}</span>
                                        </td>
                                        <td>
                                            <span
                                                class="text-muted">₦{{ number_format($product->purchase_price, 2) }}</span>
                                        </td>
