    ...
    <div class="">
        <div class="">
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body p-4" x-data="{ type: '{{ old('type', $product->type ?? 'product') }}' }">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-check-card w-100">
                                        <input type="radio" name="type" value="product" x-model="type"
                                            {{ old('type', $product->type ?? '') === 'product' ? 'checked' : '' }}>
                                        <div class="card border-2"
                                            :class="type === 'product' ? 'border-primary bg-primary-subtle' : ''">
                                            <div class="card-body py-4 text-center">
                                                <i class="isax isax-box fs-1 text-primary mb-3"></i>
                                ...
                                <div class="col-md-6">
                                    <label class="form-check-card w-100">
                                        ...
                                        <div class="card border-2"
                                            ...
                                            <div class="card-body py-4 text-center">
                                                <i class="isax isax-briefcase fs-1 text-info mb-3"></i>
