...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
        ...
        <!-- Partial Payment Modal - UPDATED WITH HIGHER Z-INDEX -->
        <div id="partialPaymentModal"
            class="fixed inset-0 z-[60] hidden items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
            <div class="animate-fade-in relative w-full max-w-md transform rounded-2xl bg-white shadow-2xl transition-all">
                <!-- Modal Header -->
