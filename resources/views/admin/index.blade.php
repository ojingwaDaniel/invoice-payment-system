            ...
            <div class="mb-8 grid grid-cols-1 gap-8 xl:grid-cols-3">
                ...
                <div class="rounded-2xl border border-gray-100 bg-white p-8 shadow-lg xl:col-span-1">
                    ...
                    <div class="space-y-6">
                        ...
                        <div
                            class="flex items-center justify-between rounded-xl bg-gray-50 p-4 transition-colors hover:bg-purple-50">
                            <div class="flex items-center">
                                <div class="mr-4 flex h-10 w-10 items-center justify-center rounded-xl bg-purple-100">
